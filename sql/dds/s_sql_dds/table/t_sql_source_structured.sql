create table if not exists s_sql_dds.t_sql_source_structured (
    ...
    valid_from      date            not null,  -- дата начала действия версии (scd type 2)
    valid_to        date            not null,  -- дата окончания действия версии (scd type 2)
    is_current      boolean         not null   -- флаг актуальности версии
);